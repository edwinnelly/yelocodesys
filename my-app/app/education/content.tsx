...
export default function EducationPage() {
  ...
  const programs = [
    ...
    },
    {
      ...
      description:
        "Create beautiful, intuitive user experiences for web and mobile apps.",
      outcomes: [
        "UI/UX Designer",
        "Product Designer",
    ...
    },
    {
      ...
      description:
        "Master cloud platforms and modern infrastructure management.",
      outcomes: [
        "Cloud Engineer",
        "DevOps Specialist",
    ...
    },
    {
      ...
      description:
        "Start your coding journey with the world's most versatile language.",
      outcomes: [
        "Python Developer",
        "Automation Engineer",
    ...
    },
    {
      ...
      description:
        "Master digital marketing strategies to grow businesses online.",
      outcomes: [
        "Digital Marketer",
        "SEO Specialist",
  ...
  const testimonials = [
    {
      ...
      quote:
        "Yelocode transformed my career. From a complete beginner to landing my dream job at PayStack in just 6 months. The mentors really care about your success.",
      image: "pics/xxc.png",
      before: "Student",
    ...
    },
    {
      ...
      quote:
        "The hands-on projects and real-world scenarios prepared me for the challenges I face daily at work. The instructors are industry experts with practical knowledge.",
    ...
    },
    {
      ...
      quote:
        "The curriculum is perfectly structured for beginners. Within 3 months of graduating, I got a job at KPMG. The career support was invaluable.",
      image: "pics/avatar.avif",
      before: "Bank Teller",
      after: "Data Analyst",
      rating: 5,
    ...
    },
    {
      ...
      quote:
        "The portfolio I built during the program got me multiple job offers. The design critiques and feedback helped me grow tremendously.",
      image: "pics/avatar.avif",
  ...
  const faqs = [
    {
      ...
      answer:
        "No! Our beginner-friendly programs are designed for complete beginners. We start from the fundamentals and gradually build up to advanced concepts. Some intermediate programs may require basic knowledge or completion of prerequisite courses.",
    },
    {
      question: "What is the time commitment per week?",
      answer:
        "We recommend 15-20 hours per week for part-time programs and 30-40 hours for full-time bootcamps. This includes live sessions, self-study, and project work. You can adjust based on your schedule.",
    },
    {
      question: "Will I receive a certificate upon completion?",
      answer:
        "Yes! All graduates receive an industry-recognized certificate from Yelocode Systems. Many programs also prepare you for professional certifications like AWS, Google, Microsoft, and CompTIA.",
    },
    {
      question: "Do you offer payment plans or scholarships?",
      answer:
        "Absolutely! We offer flexible payment plans (3-6 months installments) and have limited scholarships available for women in tech and underrepresented groups. Contact admissions for more information.",
    },
    {
      question: "What job placement assistance do you provide?",
      answer:
        "We provide comprehensive career support including resume reviews, LinkedIn optimization, mock interviews, and access to our exclusive job board with 40+ partner companies.",
    },
    {
      question: "Can I attend online or in-person?",
      answer:
        "Both! We offer fully online, hybrid, and in-person options at our Port Harcourt campus (No. 11 Elekahia). Choose what works best for you.",
    },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 text-white">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl leading-relaxed">
              Join Yelocode Systems in Port Harcourt and gain the skills you
              need to launch a successful career in technology. Project-based
              learning, expert mentorship, and job placement support.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400">
              We believe in practical, project-based learning that prepares you
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              return (
                ...
                >
                  <div
                    className={`w-14 h-14 bg-gradient-to-r ${item.color} rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                  >
            ...
            {programs.map((program, index) => {
              ...
              return (
                <Link href={program.link} key={index}>
                  <div className="group relative bg-white dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 cursor-pointer">
                    {/* Popular badge */}
                    {program.popular && (
                    ...
                    <div className="p-6">
                      <div
                        className={`w-14 h-14 bg-gradient-to-r ${program.gradient} rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                      >
                        <Icon className="w-7 h-7 text-white" />
                      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
                Our learning experience combines live instruction, recorded
                content, and hands-on projects to ensure you master every
                concept.
              </p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80">
                    No. 11 Elekahia, Port Harcourt, Nigeria
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                <a
                  href="tel:09162865693"
                ...
                <a
                  href="mailto:admissions@yelocodesys.com"
                  className="flex items-center gap-2 px-6 py-3 bg-white/20 backdrop-blur-sm rounded-xl hover:bg-white/30 transition-all"
                >
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <ChevronRight
                    className={`w-5 h-5 text-gray-500 transition-transform ${activeFaq === index ? "rotate-90" : ""}`}
                  />
                </button>
      ...
      <section className="py-20 bg-gradient-to-r from-yellow-600 to-yellow-400 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-sm text-white/80 mt-6">
            📍 No. 11 Elekahia, Port Harcourt | 📞 09162865693 | ✉️
