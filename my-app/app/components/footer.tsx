...
export default function Footer() {
  ...
  return (
    <footer className="relative  from-black to-black text-white pt-20 pb-8 overflow-hidden">
      {/* Background pattern */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-16">
          ...
          <div>
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 mb-6">
              ...
              <p className="text-xs text-white-800 mb-3">Our admissions team is here to help</p>
              <a href="mailto:admissions@yelocode.com" className="text-sm text-yellow-400 hover:text-yellow-300 transition-colors flex items-center gap-2">
