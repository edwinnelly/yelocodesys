    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
                What is <span className="text-yellow-600 dark:text-yellow-400">Python</span>?
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">
              Why Learn <span className="text-yellow-600 dark:text-yellow-400">Python</span>?
            </h2>
      ...
      <section className="py-16 bg-white dark:bg-gray-950">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">
              What You Can <span className="text-yellow-600 dark:text-yellow-400">Build</span> with Python
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400">
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">
              The Complete <span className="text-yellow-600 dark:text-yellow-400">Python Roadmap</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400">
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {[
                { phase: 'Phase 1', title: 'Python Fundamentals', weeks: 'Weeks 1-4', color: 'yellow', topics: ['Syntax & Basics', 'Data Types', 'Control Flow', 'Functions'] },
                { phase: 'Phase 2', title: 'Core Python', weeks: 'Weeks 5-8', color: 'yellow', topics: ['OOP', 'File Handling', 'Error Handling', 'Modules'] },
                { phase: 'Phase 3', title: 'Advanced Python', weeks: 'Weeks 9-12', color: 'yellow', topics: ['APIs', 'Databases', 'Web Dev', 'Data Analysis'] },
                { phase: 'Phase 4', title: 'Specialization', weeks: 'Weeks 13-16', color: 'yellow', topics: ['Machine Learning', 'Automation', 'Capstone', 'Career Prep'] }
              ].map((phase, idx) => (
      ...
      <section className="py-16 bg-white dark:bg-gray-950">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">
              16-Week <span className="text-yellow-600 dark:text-yellow-400">Python Curriculum</span>
            </h2>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">
              30+ <span className="text-yellow-600 dark:text-yellow-400">Python Projects</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400">
      ...
      <section className="py-16 bg-white dark:bg-gray-950">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">
              Python Libraries You'll <span className="text-yellow-600 dark:text-yellow-400">Master</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <p className="text-yellow-100">Join thousands of students who have mastered Python with Yelocode.</p>
            </div>
            <div className="flex flex-wrap gap-4">
              <Link href="/Careers">
